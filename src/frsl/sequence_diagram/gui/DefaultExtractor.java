...
//	public DefaultExtractor(OldUseCase usecase, Model model) {
//		this.usecase = usecase;
//		this.model = model;
//	}

	@Override
	public String extractAdditionalInfo(UseCase usecase, Model model) {
...
//			}
			...
			if (node instanceof FlowStep) {
				...
				NavigableStep flowStep = (NavigableStep) node;
					...
					try {
						...
						if (start < end) {
							for (int i = start; i <= end; i++) {
								//FIXME
								NavigableStep stepInBasicFlow = usecase.getFlowStep(i);
